      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-purple-300 text-xl opacity-80 max-w-2xl mx-auto">
            Help Lil Ghost pinpoint your appliances!
          </p>
        </div>
          ...
          <div className="bg-gray-900/60 border border-purple-500/30 rounded-lg p-8 shadow-lg shadow-purple-500/10">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-gray-300">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-purple-300 mb-2">Step 1:</h3>
                <p className="text-sm">Click on a device button to begin the calibration</p>
              </div>
              <div className="text-center">
                <div className="text-2xl mb-2">👁️</div>
                <h3 className="font-semibold text-purple-300 mb-2">Step 2:</h3>
                <p className="text-sm">You will have 5 seconds to point the controller towards the device</p>
              </div>
              <div className="text-center">
                <div className="text-2xl mb-2">⚡</div>
                <h3 className="font-semibold text-purple-300 mb-2">Step 3:</h3>
                <p className="text-sm">The final position will be set for your device</p>
              </div>
            </div>
          </div>
        </div>
